$(document).ready(function () {
  ...
  changeSale('.header-content', '.header-pr-new', '.header-pr-old', '.header-top__sale');
  changeSale('.footer', '.header-pr-new', '.header-pr-old', '.footer__sale');
  changeSale('.product', '.prod-price__new', '.prod-price__old', '.prod-sale');
  changeSale('.spray-content', '.spray-info-price__new', '.spray-info-price__old', '.spray-title span');
